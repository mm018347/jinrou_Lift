...
class RoomController {
  ...
  def add (xhtml : Group) : NodeSeq = {
    ...
    def create_room () {
      ...
      // 加入替身君
      val dummy_boy = UserEntry.create.uname("dummy_boy").handle_name(dummy_handle_name.replace('　',' ').trim()).trip("GQ5ZTY5Z").sex("M").user_icon_id(1)
      .password("PPNQol99tSyPTZq+l3fy").last_words(last_words).role(RoleEnum.NONE.toString).subrole("")
    ...
    bind("entry", xhtml,
	  ...
	  "anonymous_mode"         -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.ANONYMOUS_MODE),     "id"->"anonymous_mode"),
      ...
      "dummy_reveal"      -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.DUMMY_REVEAL),  "id"->"dummy_reveal"),
      ...
      "death_look"        -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.DEATH_LOOK),    "id"->"death_look"),
      ...
      "weather"           -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.WEATHER),       "id"->"weather"),
	  ...
	  "lover_init"       -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.LOVER_INIT),     "id"->"lover_init"),
	  "lover_letter_exchange"       -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.LOVER_LETTER_EXCHANGE),     "id"->"lover_letter_exchange"),
      ...
      "role_aughunter"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.ROLE_AUGHUNTER),"id"->"role_aughunter"),
      ...
      "role_fallen_angel" -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.ROLE_FALLEN_ANGEL), "id"->"role_fallen_angel"),

      "role_pontiff"      -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.ROLE_PONTIFF),  "id"->"role_pontiff"),
      "role_penguin"      -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.ROLE_PENGUIN),  "id"->"role_penguin"),
      ...
      "subrole_avenger"      -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SUBROLE_AVENGER), "id"->"subrole_avenger"),
      ...
      "subrole_wisewolf"     -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SUBROLE_WISEWOLF),     "id"->"subrole_wisewolf"),
      "subrole_subpontiff"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SUBROLE_SUBPONTIFF), "id"->"subrole_subpontiff"),
      ...
      "necromancer_option1"-> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.NECROMANCER_OPTION1), "id"->"necromancer_option1"),
      "hunter_option1"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.HUNTER_OPTION1), "id"->"hunter_option1"),
      "hunter_option2"    -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.HUNTER_OPTION2), "id"->"hunter_option2"),
      "gemini_daytalk"    -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.GEMINI_DAYTALK), "id"->"gemini_daytalk"),
      ...
      "cleric_option1"    -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.CLERIC_OPTION1), "id"->"cleric_option1"),
      "cleric_option2"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.CLERIC_OPTION2), "id"->"cleric_option2"),
	  "cleric_option3"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.CLERIC_OPTION3), "id"->"cleric_option3"),
	  "cleric_option4"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.CLERIC_OPTION4), "id"->"cleric_option4"),
      "herbalist_mix"     -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.HERBALIST_MIX), "id"->"herbalist_mix"),
      "herbalist_drop"    -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.HERBALIST_DROP), "id"->"herbalist_drop"),
      "scholar_option1"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SCHOLAR_OPTION1), "id"->"scholar_option1"),
      "scholar_option2"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.SCHOLAR_OPTION2), "id"->"scholar_option2"),
      "scholar_option3"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SCHOLAR_OPTION3), "id"->"scholar_option3"),
      ...
      "runner_option3"    -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.RUNNER_OPTION3), "id"->"runner_option3"),
      ...
      "madman_stun"       -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.MADMAN_STUN),     "id"->"madman_stun"),
      ...
      "fox_option2"       -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.FOX_OPTION2),      "id"->"fox_option2"),
      "fox_option3"       -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.FOX_OPTION3),      "id"->"fox_option3"),
      "fox_option4"       -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.FOX_OPTION4),      "id"->"fox_option4"),
      "betrayer_option1"  -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.BETRAYER_OPTION1), "id"->"betrayer_option1"),
      "betrayer_option2"  -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.BETRAYER_OPTION2), "id"->"betrayer_option2"),
      "betrayer_option3"  -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.BETRAYER_OPTION3), "id"->"betrayer_option3"),
      "godfat_special1"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.GODFAT_SPECIAL1),  "id"->"godfat_special1"),
      "godfat_special2"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.GODFAT_SPECIAL2),  "id"->"godfat_special2"),
      "godfat_special3"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.GODFAT_SPECIAL3),  "id"->"godfat_special3"),
      ...
      "demon_option2"     -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.DEMON_OPTION2),    "id"->"demon_option2"),
      "demon_option3"     -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.DEMON_OPTION3),    "id"->"demon_option3"),
      "penguin_option1"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.PENGUIN_OPTION1),  "id"->"penguin_option1"),
      "penguin_option2"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.PENGUIN_OPTION2),  "id"->"penguin_option2"),
      "penguin_option3"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.PENGUIN_OPTION3),  "id"->"penguin_option3"),
      "penguin_option4"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.PENGUIN_OPTION4),  "id"->"penguin_option4"),
      "pontiff_option1"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.PONTIFF_OPTION1), "id"->"pontiff_option1"),
      "pontiff_option2"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.PONTIFF_OPTION2), "id"->"pontiff_option2"),
      "pontiff_option3"   -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.PONTIFF_OPTION3), "id"->"pontiff_option3"),
	  "pontiff_option4"   -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.PONTIFF_OPTION4), "id"->"pontiff_option4"),
      "inheriter_reveal"  -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.INHERITER_REVEAL), "id"->"inheriter_reveal"),
      ...
      "shifter_reveal"    -> SHtml.checkbox(true, if (_) option_list = option_list ::: List(RoomFlagEnum.SHIFTER_REVEAL), "id"->"shifter_reveal"),
      "shifter_links"     -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.SHIFTER_LINKS), "id"->"shifter_links"),
	  "shifter_random"     -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.SHIFTER_RANDOM), "id"->"shifter_random"),
	  ...
	  "heretic_option1" -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.HERETIC_OPTION1), "id"->"heretic_option1"),
	  "fallenangel_option1" -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.FALLENANGEL_OPTION1), "id"->"fallenangel_option1"),
	  ...
	  "gm_heretic1"         -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.GM_HERETIC1), "id"->"gm_heretic1"),
	  "gm_heretic2"         -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.GM_HERETIC2), "id"->"gm_heretic2"),
	  "gm_spy1"             -> SHtml.checkbox(false, if (_) option_list = option_list ::: List(RoomFlagEnum.GM_SPY1), "id"->"gm_spy1"),
